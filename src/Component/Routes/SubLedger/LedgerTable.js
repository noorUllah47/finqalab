...
const data = [
  {
    ...
    Description: "UIN ACCOUNT OPENING CHARGES ill",
    Sett_Date: "18-May-22",
    Credit:"400,000",
    Debit: "300,000",
  ...
  },
  {
    ...
    Created_Date: "5-7-2022 12:40PM",
    Description: "UIN ACCOUNT OPENING CHARGES ",
    Sett_Date: "25-May-22",
    Credit:"400,000",
    Debit: "300,000",
...
const LedgerTable = () => {
  ...
  ...getColumnSearchProps('Created_Date'),
    ...
    
    {
      ...
      dataIndex: "Sett_Date",
      sorter: {
        compare: (a, b) => new Date(a.Sett_Date) - new Date(b.Sett_Date),
        // multiple: 3,
      },
      width: 3,
  ...getColumnSearchProps('Sett_Date'),
